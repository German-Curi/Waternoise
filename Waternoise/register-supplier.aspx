<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register-supplier.aspx.cs" Inherits="Waternoise.register_supplier" %>
    ...
    <div class="content-box">
        ...
        <form runat="server">
            ...
            <div class="mb-3">
                ...
                <asp:RequiredFieldValidator ID="nameRequired" runat="server" ControlToValidate="name" ErrorMessage="El nombre del proveedor es obligatorio" CssClass="text-danger" Display="Dynamic" />
            </div>
            ...
            <!-- Botón de registro -->
            <asp:Button ID="registrarProveedor" runat="server" CssClass="blue-btn" Text="Registrar" OnClick="registrarProveedor_Click"/>
