<%@ Page Title="" Language="C#" MasterPageFile="~/APPLICANT/MasterPageApplicant.Master" AutoEventWireup="true" CodeBehind="profile-applicant.aspx.cs" Inherits="Waternoise.profile_applicant" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="catalog-container">             
        ...
        <div class="mb-3">
            <label for="txtCreacion" class="form-label">Fecha de Creación</label>
