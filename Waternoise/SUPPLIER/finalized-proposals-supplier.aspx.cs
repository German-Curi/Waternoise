...
{
    public partial class finalized_proposals_supplier : System.Web.UI.Page
    {
        ...
        private void LoadProposals()
        {
            ...
            int? advisorID = int.Parse(Session["UserID"].ToString()); ; // No se filtra por asesor
            int? userRequestID = null;
        ...
        protected void rptProposals_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "ViewProposal")
            {
                ...
                Response.Redirect($"view-finalized-proposal-supplier.aspx?proposalId={proposalId}");
            }
        }
