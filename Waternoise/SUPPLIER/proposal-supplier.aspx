<%@ Page Title="" Language="C#" MasterPageFile="~/SUPPLIER/MasterPageSupplier.master" AutoEventWireup="true" CodeBehind="proposal-supplier.aspx.cs" Inherits="Waternoise.SUPPLIER.proposal_supplier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="d-flex justify-content-between align-items-center">
        <h2 class="form-title">Propuestas de Proveedores</h2>
    </div>
    <br/>
    ...
    <asp:Repeater ID="rptProposals" runat="server" OnItemCommand="rptProposals_ItemCommand">
        <ItemTemplate>
            <div class="catalog-container">
                ...
                <p>
                    Número Solicitud: #<%# Eval("RequestID") %> |
