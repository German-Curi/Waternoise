<%@ Page Title="" Language="C#" MasterPageFile="~/SUPPLIER/MasterPageSupplier.master" AutoEventWireup="true" CodeBehind="view-proposal-supplier.aspx.cs" Inherits="Waternoise.view_proposal_supplier" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col px-1 py-1">
        <h2 class="form-title" style="text-align: left;">
            <a href="proposal-supplier.aspx">Propuestas</a> &rarr; Visualizar Propuesta
        </h2>
        ...
        <div class="row mb-3 align-items-center">
            ...
            <div class="col-md-6 text-end">
                <asp:Button ID="btnCerrarPropuesta" runat="server" Text="Cerrar Propuesta" class="btn blue-btn" OnClick="btnCerrarPropuesta_Click" />
            </div>
        </div>
    </div>
</asp:Content>
