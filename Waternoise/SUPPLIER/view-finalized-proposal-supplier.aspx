<%@ Page Title="" Language="C#" MasterPageFile="~/SUPPLIER/MasterPageSupplier.master" AutoEventWireup="true" CodeBehind="view-finalized-proposal-supplier.aspx.cs" Inherits="Waternoise.SUPPLIER.view_finalized_proposal_supplier" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col px-1 py-1">
        <h2 class="form-title" style="text-align: left;">
            <a href="finalized-proposals-supplier.aspx">Propuestas Finalizadas</a> &rarr; Visualizar Propuesta
        </h2>
